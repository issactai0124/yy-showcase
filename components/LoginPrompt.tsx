    ...
    <div className="flex flex-col items-center justify-center p-8 h-full space-y-8 animate-fade-in">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-500 mt-1">
          {step === 'name' ? '請告訴我們該如何稱呼您' : '登入後即可享受完整社群服務'}
        </p>
      </div>
      ...
      <div className="w-full space-y-4">
        {step === 'phone' && (
          <>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-medium">+852</span>
              <input 
                type="tel"
                placeholder="手機號碼"
        ...
        {step === 'otp' && (
          <>
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-500 ml-1">驗證碼</label>
              <input 
                type="text"
                maxLength={4}
        ...
        {step === 'name' && (
          <>
            <div className="space-y-1">
              <label className="text-xs font-bold text-slate-500 ml-1">您的名稱</label>
              <input 
                autoFocus
                type="text"
                placeholder="例如：陳大文"
